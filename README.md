...
The sample file `./T32TQM_20241115T100159_B03_10m_with_TLM.jp2` was generated by injecting a computed TLM table into the original JP2 file. One can also use GDAL to with the following command:
```bash
